<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('dashboard.index') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">TMN Industry</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Voucher -->
        <li class="menu-item {{ request()->routeIs('user.voucher') ? 'active' : '' }}">
            <a href="{{ route('user.voucher') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-id-card"></i>
                <div data-i18n="Analytics">Vouchers</div>
            </a>
        </li>
    </ul>
</aside>
